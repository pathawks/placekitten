...
1. Upload `placekitten` to the `/wp-content/plugins/` directory
2. Activate **placekitten** through the 'Plugins' menu in WordPress
3. In the Post editor, type `[placekitten]` to embed a picture of a kitten. You can also specify height and width by using `[placekitten height="200" width="200"]`
...
Please send me a message with an explanation of what you were expecting vs. what went wrong, and I'll try to fix it in a future release.
placekitten@pathawks.com
